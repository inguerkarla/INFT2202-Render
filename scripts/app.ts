...
(function () {
    ...
    function DisplayStatisticsPage() {
        ...
        // Fetch statistical data from JSON file or external API
        fetch('./data/statistics.json')
            ...
            .then(data => {
                ...
                const ctx = document.getElementById('statistics-chart') as HTMLCanvasElement | null;
                if (ctx) {
                    console.log(ctx)
...
// Fetch news when the page loads
    ...
    loadBlogs("search term"); // To load blogs filtered by a search term
