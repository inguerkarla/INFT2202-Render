...
(function () {
    ...
    /**
     *Sets up event listeners for navigation links found within the list items of unsorted list
     * Removes any existing click and mouseover events before adding new ones to control navigation behaviour and
     * visual cue
     * @returns {void}
     */
    function AddNavigationEvents():void{
        let navLinks = $("ul>li>a");//find all navigations links
    ...
    function AddContact(fullName:string, contactNumber:string, emailAddress:string) {
        console.log(`AddContact ${fullName} ${contactNumber} ${emailAddress}`)
    ...
    function DisplayContactListPage() {
        ...
        if (localStorage.length > 0) {
            let contactList = document.getElementById("contactList") as HTMLBRElement;
            let data = "";
